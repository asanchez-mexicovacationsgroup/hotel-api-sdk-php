 ...
 * @property double minRate It filters rates which ‘net’ value is lower than minRate
 * @property double maxRate It filters rates which ‘net’ value is higher than maxRate
