...
/**
 * Class AccommodationListRQ
 * @package hotelbeds\hotel_api_sdk\messages
 */
class AccommodationListRQ extends ContentApiRequest
{
    /**
     * AccommodationListRQ constructor.
     * @param ApiUri $baseUri
     * @param ContentApiParams $data
     */
    public function __construct(ApiUri $baseUri, ContentApiParams $data)
    {
        parent::__construct($baseUri, self::ACCOMMODATIONS);
